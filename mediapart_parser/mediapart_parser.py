...
class MediapartParser:
    ...
    def get_article_id(self, article_url):
        ...
        result = soup.find("div", {"class": "sub-header accur8-desktop\
            accur8-tablet accurWidth-desktop accurWidth-tablet"})
    ...
    def url_to_pdf(self, article_id, final_file_path):
        ...
        s = Session()
        login_data = {"name": self.mediapart_user,
                      "password": self.mediapart_pwd, "op": "Se+connecter"}
